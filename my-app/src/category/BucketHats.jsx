...
const fetchProducts=async()=>{
  setLoading(true)
  const response = await axiosClient.get("api/products/category/bucketHats/5");
  ...
  <CategoryCard grid={2} name="Man" image={men}  route="/man_bucket_hat" />
  <CategoryCard grid={2} name="Woman" image={women}  route="/woman_bucket_hat" />
  <CategoryCard grid={2} name="Kids" image={kids}  route="/kids_bucket-hat" />
