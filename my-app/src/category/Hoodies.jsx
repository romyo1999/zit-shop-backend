...
const fetchProducts=async()=>{
  setLoading(true)
  const response = await axiosClient.get("api/products/category/hoodies/2");
  ...
  <CategoryCard grid={2} name="Man" image={men}  route="/man_hoodie" />
  <CategoryCard grid={2} name="Woman" image={women}  route="/woman_hoodie" />
  <CategoryCard grid={2} name="Kids" image={kids}  route="/kids_hoodie" />
