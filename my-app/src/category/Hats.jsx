...
const fetchProducts=async()=>{
  setLoading(true)
  const response = await axiosClient.get("api/products/category/hats/4");
  ...
  <CategoryCard grid={2} name="Man" image={men}  route="/man_hat" />
  <CategoryCard grid={2} name="Woman" image={women}  route="/woman_hat" />
  <CategoryCard grid={2} name="Kids" image={kids}  route="/kids_hat" />
