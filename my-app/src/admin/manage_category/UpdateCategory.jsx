...
const UpdateCategory = () => {
    ...
    useEffect(()=>{
        ...
        .then((response)=>{
            if(response.data.status===404){
                ...
                setBody(response.data.category.feature)
                setSize(response.data.category.size)
                setExist(true)
            }
        })
    ...
    const handleUpdateCategory =async(e)=>{
        ...
        try {
            setLoading(true)
            const response=await axiosClient2.patch(`api/category/${id}` ,Data);
    ...
    <div className='container-fluid' style={{background:"#f0f0f0"}}>
        ...
        return(
            ...
            <div style={{marginTop:"40%"}}>
                <h2 className='text-secondary text-center mt-4'>Category Nout Found</h2>
